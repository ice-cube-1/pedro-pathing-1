...
@Autonomous
public class NearLeave extends LinearOpMode {
    private Follower follower;

    public void runOpMode()  {
        waitForStart();
        ArrayList<Pose> poses = new ArrayList<>();
        poses.add(new Pose(ALLIANCE_COLOUR.mirrorX(24+ROBOT_WIDTH_CM/(2.54*2)),144.0-ROBOT_LENGTH_CM/(2.54), toRadians(270))); // start
        poses.add(new Pose(ALLIANCE_COLOUR.mirrorX(48), 144-6, toRadians(270))); // stop intaking here
